            ...
            <div>
                ...
                <motion.ul 
                    ...
                    <li className="flex items-center">
                        ...
                        <a href="mailto:samuproperities@gmail.com" className="text-white text-sm ml-4">
                    ...
                    <li className="flex items-center">
                        ...
                        <a href="tel:+18739931780" className="text-white text-sm ml-4">
                            {setting.contactPhoneNumber}
                        </a>
                    </li>
                    <li className="flex items-center">
                ...
                <motion.ul 
                    ...
                    <li className="bg-[#173567] hover:bg-[#1064a9e2] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
