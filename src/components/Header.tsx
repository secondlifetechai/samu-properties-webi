  ...
  return (
    <nav className="bg-[#173567] fixed w-full z-20 top-0 start-0 border-b border-gray-600">
        ...
        <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            <a href={`mailto:${setting?.contactEmail}`} target="_blank">
            ...
            <button 
                ...
                data-collapse-toggle="navbar-sticky" type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-300 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-sticky" aria-expanded="false">
